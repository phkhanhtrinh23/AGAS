#!/bin/bash
# Multi-seed validation: rule_baseline vs v3_full, n=5 (seeds 42-46).
# Uses the current strategic policy (4 strategies: STEALTH_REBUILD,
# CONSENSUS_HOLD, BUDGET_PRESSURE, CO_VOTING_DIVERSITY).

set -e
mkdir -p /mnt/win_d/agent_attack_rs/outputs/multiseed_sweep
